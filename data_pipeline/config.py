...
MERGED = os.path.join(DATA, "nepali_clean.txt")        # deduped + mixed training corpus (1 doc/line)
LIT_TEST = os.path.join(DATA, "literature_test.txt")   # held-out clean literature (never trained on)
...
SOURCES = {
    ...
    "wikipedia": {
        "loader": ("hf", {"path": "wikimedia/wikipedia", "name": "20231101.ne", "split": "train"}),
        "text_col": "text",
    ...
    "textbooks": {
        "loader": ("hf", {"path": "dineshkarki/nepali-textbooks-corpus", "split": "train"}),
        "text_col": "text",
        "max_chars": 60_000_000,
    ...
    "devkota": {
        "loader": ("url", {"url": "https://raw.githubusercontent.com/devkotasawal1/Poem-Generator/master/lspd.txt"}),
        "text_col": None,
        "max_chars": 10_000_000,
        "min_dev_ratio": 0.20,
        "weight": 5,             # public-domain literature, up-weight hard
        "holdout": 0.15,
    },
}
